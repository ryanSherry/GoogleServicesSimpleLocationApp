...
public class LocationProviderRefresh implements
    ...
    public LocationProviderRefresh(LocationProvider.LocationCallback locationCallback, Context context, FusedLocationProviderClient fusedLocationProviderClient, com.google.android.gms.location.LocationCallback gmsLocationCallback, LocationManager locationManager) {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (checkPermissions((Activity)mContext)) {
            ...
            requestLocationUpdates(mFusedLocationProviderClient, gmsLocationCallback,mLocationManager,LocationProviderRefresh.this);
